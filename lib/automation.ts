...
4. H2 & H3 OUTLINE HIERARCHY:
   ...
   - Step 2: Under EACH H2 section, generate relevant H3 sub-headings ("### [H3 Sub-Section Title]").
   - Step 3: Write detailed, informative, multi-paragraph content under each H2 and H3 section.
   ...
   - NON-LISTICLE RULE (CRITICAL): For standard topics that DO NOT contain a number in the keyword (e.g. "moon light lamp", "bathroom tiles"), DO NOT use numbers (1., 2., 3.) in H2 headings! Use clean, natural descriptive headings like "## 3D Printing Technology and Topographical Lunar Accuracy".

5. CONTENT ORIGINALITY & DENSITY:
   - Every single article must be 100% unique and dynamically generated by Gemini. No hardcoded default content.
   - Write clear, engaging, high-density editorial prose answering user search intent thoroughly.
