...
4. H2 & H3 OUTLINE HIERARCHY:
   ...
   - LISTICLE RULE: If keyword includes a number N (e.g., "5 best...", "6 best..."), create N item headings ("## 1. [Item Name]", "## 2. [Item Name]" up to "## N. [Item Name]") with H3 sub-features under each item.
