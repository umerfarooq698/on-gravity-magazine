...
export default function CategoryPageFeed({ category, initialArticles }: CategoryPageFeedProps) {
  ...
  const refreshArticles = () => {
    ...
    for (const art of [...customArticles, ...initialArticles]) {
      if (art.category === category.slug && !map.has(art.slug)) {
