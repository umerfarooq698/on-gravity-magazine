...
export const ARTICLES: Article[] = [
...
},
  {
    ...
    "metaDescription": "Modern bathroom tiles design pairs durable porcelain wall layouts with anti-slip floor tiles for elegant, low-maintenance washroom spaces.",
    "excerpt": "Modern bathroom tiles design pairs durable porcelain wall layouts with anti-slip floor tiles for elegant, low-maintenance washroom spaces.",
    "content": [
  ...
  },
  {
    ...
    "metaDescription": "Character bathrooms combine vintage clawfoot tubs, reclaimed timber vanities, exposed brick, and antiqued brass fixtures for home warmth.",
    "excerpt": "Character bathrooms combine vintage clawfoot tubs, reclaimed timber vanities, exposed brick, and antiqued brass fixtures for home warmth.",
    "content": [
